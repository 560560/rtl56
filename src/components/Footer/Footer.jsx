        ...
        <div className="container">
            <div className="footerWrapper">
                ...
                <div className="footerItem email">
                    <div className="icon"><a href="mailto:rostehlizing.56@mail.ru"><FiMail/></a></div>
                    <div className="text"><a href="mailto:rostehlizing.56@mail.ru"><span>rostehlizing.56@mail.ru</span></a></div>
                </div>
