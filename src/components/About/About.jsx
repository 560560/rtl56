    ...
    return (
        <div className="aboutWrapper">
            ...
            <header className="header">
                <h1>О компании</h1>
                <p>Компания «РосТехЛизинг» с 2008 года помогает малому и среднему бизнесу развиваться, предоставляя в лизинг автотранспорт, спецтехнику и
                    оборудование.</p>
            ...
            <div className="leftSide">
                <div className="aboutText">
                    ...
                    <p>«РосТехЛизинг» предлагает клиентам весь комплекс услуг при приобретении оборудования и автотранспорта, включая страхование, помощь в выборе
                        поставщика, согласование с ним условий поставки, монтажа оборудования. </p>
                    <p>Учитывая специфику каждого бизнеса «РосТехЛизинг» ориентировано на индивидуальный подход к каждому клиенту, что позволяет совместно с клиентом
                        разрабатывать наиболее подходящий для него график выплаты денежных средств.
                    </p>
                </div>
            </div>
