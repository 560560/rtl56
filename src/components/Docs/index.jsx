  ...
  return (
    <div className="docsWrapper">
      <div className="choseWrapper">
        <div
          className={currentTab === 'ur' ? 'headerButton headerUr active' : 'headerButton headerUr notActive'}
          onClick={() => setCurrentTab('ur')}
        >
          <h2 className="desktop">
            ПЕРЕЧЕНЬ ДОКУМЕНТОВ для рассмотрения заявки о заключении лизинговой сделки <br />
            (по юридическим лицам)
          </h2>
          <h2 className="mobile">Юридическим лицам</h2>
        </div>
        <div
          className={currentTab === 'fiz' ? 'headerButton headerFiz active' : 'headerButton headerFiz notActive'}
